...
/*! \var BOOL __sUseQuietLog
 \brief Controls the logging function by log...:/debugLog...:/warn...: methods
 
 Flag boolean - if YES the ASLog mehods will use QuietLog() instead of NSLog(). Set to
 NO by default, can be changed by calls to setQuietOn: allowing programmatic control.
 
 Can also be enabled by #defining DEBUG_LOG_QUIET_ENABLE
 */
static BOOL __sUseQuietLog = NO;
...
/*! \var void (*__sCurLogFunc)(NSString *format, ...);
 ...
 log text. Currentlt will be either NSLog() (the default) or QuietLog().
 */
